<template>
  ...
  <div
    ...
    @click='filter()'
    class='inline-block text-lg border border-black rounded-2xl px-4 py-1 mr-2 hover:cursor-pointer'
  ...
  <div v-else class='inline-block text-lg border border-black rounded-2xl px-4 py-1 mr-2' :class='`bg-${bgColor}-200`'>
    {{ formattedName }}
  </div>
</template>
